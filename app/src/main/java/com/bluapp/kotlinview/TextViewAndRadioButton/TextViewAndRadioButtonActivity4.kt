...
class TextViewAndRadioButtonActivity4 : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_text_view_and_radio_button4)
        ...
        textview.background = resources.getDrawable(R.drawable.rounded_textview)
