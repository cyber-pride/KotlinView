...
class ViewPagerActivity1 : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when (item.getItemId()) {
            ...
            R.id.action_activityviewpager16 -> {
                startActivity(Intent(this@ViewPagerActivity1, ViewPagerActivity16::class.java))
                return true
            }
            R.id.action_activityviewpager17 -> {
                startActivity(Intent(this@ViewPagerActivity1, ViewPagerActivity17::class.java))
                return true
            }
            R.id.action_activityviewpager18 -> {
                startActivity(Intent(this@ViewPagerActivity1, ViewPagerActivity18::class.java))
                return true
            }
            R.id.action_activityviewpager19 -> {
                startActivity(Intent(this@ViewPagerActivity1, ViewPagerActivity19::class.java))
                return true
            }
            R.id.action_activityviewpager20 -> {
                startActivity(Intent(this@ViewPagerActivity1, ViewPagerActivity20::class.java))
                return true
            }
        }
