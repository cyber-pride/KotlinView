...
class NavigationActivity3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val listHeaderView = inflater.inflate(R.layout.drawer_header, null, false);
        mNavigationView!!.addHeaderView(listHeaderView)
