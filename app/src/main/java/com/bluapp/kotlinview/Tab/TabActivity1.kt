...
class TabActivity1 : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when (item.getItemId()) {
            ...
            R.id.action_activitytab13 -> {
                startActivity(Intent(this@TabActivity1, TabActivity13::class.java))
                return true
            }
            R.id.action_activitytab14 -> {
                startActivity(Intent(this@TabActivity1, TabActivity14::class.java))
                return true
            }
            R.id.action_activitytab15 -> {
                startActivity(Intent(this@TabActivity1, TabActivity15::class.java))
                return true
            }
            R.id.action_activitytab16 -> {
                startActivity(Intent(this@TabActivity1, TabActivity16::class.java))
                return true
            }
            R.id.action_activitytab17 -> {
                startActivity(Intent(this@TabActivity1, TabActivity17::class.java))
                return true
            }
            R.id.action_activitytab18 -> {
                startActivity(Intent(this@TabActivity1, TabActivity18::class.java))
                return true
            }
        }
